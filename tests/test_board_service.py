...
def test_create_board_assigns_owner(db_session):
    user = User(
    ...
    board = board_service.create_board(board_data, user)
...
def test_get_all_boards_returns_only_user_boards(db_session):
    owner = User(
